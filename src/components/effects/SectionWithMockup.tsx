// SectionWithMockup — sección con parallax y scroll animations
// Adaptado de 21st.dev/r/erikx/section-with-mockup para el portfolio de Andrea
'use client';
    ...
    return (
        <section className="relative py-24 md:py-48 bg-background overflow-hidden">
            <div className="container max-w-[1220px] w-full px-6 md:px-10 relative z-10 mx-auto">
                ...
                >
                    ...
                    >
                        ...
                        <motion.div
                            className={`absolute w-[300px] h-[317px] md:w-[472px] md:h-[500px] bg-card/20 rounded-[32px] z-0`}
                            style={{
                        ...
                        {/* Main Mockup Card */}
                        <motion.div
                            className="relative w-full h-[405px] md:h-[637px] bg-white/5 rounded-[32px] backdrop-blur-[15px] backdrop-brightness-[100%] border border-white/10 z-10 overflow-hidden"
                            initial={{ y: 0 }}
                            whileInView={{ y: reverseLayout ? 20 : 30 }}
            ...
            <div
                ...
                style={{
                    background:
                        "radial-gradient(50% 50% at 50% 50%, rgba(37,99,235,0.24) 0%, rgba(37,99,235,0) 100%)",
                }}
            />
        </section>
    );
