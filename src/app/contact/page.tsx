              ...
              <FadeIn delay={0.05}>
                <div className="flex flex-col items-center justify-center py-16 text-center rounded-xl border border-green-200 bg-green-50/50 dark:border-green-900/40 dark:bg-green-950/20 transition-colors">
                  ...
                  <button
                    ...
                    className="mt-6 px-6 py-2.5 text-sm font-medium border border-white/[0.06] rounded-xl hover:border-primary/30 hover:text-primary transition-colors"
                  >
                    Enviar otro mensaje
                  </button>
                </div>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        required
                        className="w-full h-12 px-4 rounded-xl border border-white/[0.06] bg-background text-base placeholder:text-muted-foreground/50 focus:border-primary/50 focus:ring-2 focus:ring-primary/20 outline-none transition-colors"
                      />
                    </div>
                    <div className="space-y-2">
                      <label
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      required
                      className="w-full min-h-[150px] px-4 py-3 rounded-xl border border-white/[0.06] bg-background text-base placeholder:text-muted-foreground/50 focus:border-primary/50 focus:ring-2 focus:ring-primary/20 outline-none transition-colors resize-none"
                    />
                  </div>
